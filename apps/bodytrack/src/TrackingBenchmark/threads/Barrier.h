...
public:
  virtual const char* what() const throw() {
    return "Unspecified barrier error";
  }
};
...
public:
  virtual const char* what() const throw() {
    return "Unspecified error while initializing barrier";
  }
};
...
public:
  virtual const char* what() const throw() {
    return "Unspecified error while destroying barrier";
  }
};
...
public:
  ...
  // Wait at a barrier, will return true for exactly one thread, false for all
  // other threads
