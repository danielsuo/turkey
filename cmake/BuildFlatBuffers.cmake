...
function(build_flatbuffers flatbuffers_schemas
	...
	foreach(schema ${flatbuffers_schemas})
		...
		if (NOT ${generated_includes_dir} STREQUAL "")
			...
			add_custom_command(
				...
				${include_params}
				-c ${schema} ${additional_flags}
				DEPENDS ${FLATC_TARGET} ${schema} ${additional_dependencies}
				COMMENT "Building ${additional_flags} headers for ${schema}")
	...
	# to be built.
	add_custom_target(
		${custom_target_name} ALL DEPENDS ${all_generated_files} ${additional_dependencies})
